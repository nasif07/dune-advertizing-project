...
const About = () => {
    ...
    return (
        <div className="bg-light-gray font-Space_Grotesk md:px-10 px-4 font-DM_sans">
                ...
                <div className="flex flex-col-reverse md:flex-row  items-center md:gap-5 lg:gap-[132px]">
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute top-10 right-20">
                            <p className="text-white text-[13px] font-normal pb-2">Our Customers</p>
                    ...
                    <div className="flex-1 my-[50px] md:my-[50px]">
                        <h1 className="text-white text-2xl md:text-[30px] lg:text-[40px] md:leading-tight max-w-[300px]">Why should you choose Dune</h1>
                        ...
                        <div className="flex gap-3 items-center pb-[10px]">
                            ...
                            <h4 className="text-white text-[16px] font-medium">Lorem ipsum dolor sit amet, consetetur sadipscing</h4>
                        </div>
                        <div className="flex gap-3 items-center pb-[10px]">
                            <img className="w-5" src={aeroIcon} alt="" />
                            <h4 className="text-white text-[16px] font-medium">sed diam nonumy eirmod tempor Lorem ipsum dolor</h4>
                        </div>
                        <div className="flex gap-3 items-center pb-[10px]">
                            <img className="w-5" src={aeroIcon} alt="" />
                            <h4 className="text-white text-[16px] font-medium">sed diam nonumy eirmod tempor Lorem ipsum dolor</h4>

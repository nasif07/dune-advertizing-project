...
const Banner = () => {
    return (
        <>
        <div style={{ backgroundImage: `url('${moduleName}')` }} className='bg-cover bg-no-repeat md:bg-center  h-[1095px] font-DM_sans'>
            <NavBar></NavBar>
            <div className='text-center text-white max-w-[800px] mx-auto'>
                <h1 className='text-[96px] leading-tight pt-[54px] pb-10 font-DM_sans'>Navigating the Digital Landscape</h1>
                <div className=''>

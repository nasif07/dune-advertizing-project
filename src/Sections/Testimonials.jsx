                    ...
                    <div className="relative overflow-hidden">
                        <div className="absolute w-full h-full flex items-center justify-between z-50 ">
                            ...
                            <button onClick={prevSlider} className="flex justify-center items-center hover:bg-white/30 rounded-full w-6 h-6 md:w-10 md:h-10 mr-12">
                                <svg viewBox="0 0 1024 1024" className="w-4 h-4 md:w-9 md:h-9 icon" xmlns="http://www.w3.org/2000/svg" fill="white"> <g id="SVGRepo_bgCarrier" strokeWidth="0"></g> <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g> <g id="SVGRepo_iconCarrier"><path fill="white" d="M685.248 104.704a64 64 0 010 90.496L368.448 512l316.8 316.8a64 64 0 01-90.496 90.496L232.704 557.248a64 64 0 010-90.496l362.048-362.048a64 64 0 0190.496 0z"></path></g>
                                </svg>
                            </button>
                            {/* arrow right */}
                            <button onClick={nextSlider} className="flex justify-center items-center hover:bg-white/30 rounded-full w-6 h-6 md:w-10 md:h-10">
                                <svg viewBox="0 0 1024 1024" className="w-4 h-4 md:w-9 md:h-9 icon" xmlns="http://www.w3.org/2000/svg" fill="white" transform="rotate(180)"> <g id="SVGRepo_bgCarrier" strokeWidth="0"></g> <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g> <g id="SVGRepo_iconCarrier"> <path fill="white" d="M685.248 104.704a64 64 0 010 90.496L368.448 512l316.8 316.8a64 64 0 01-90.496 90.496L232.704 557.248a64 64 0 010-90.496l362.048-362.048a64 64 0 0190.496 0z" ></path></g>
                                </svg>
                            </button>
                        </div>
                        {/* slider container */}
                        <div
                            ...
                            {array.map((each, idx) => (
                                <div key={idx} className="p-10 min-w-full md:min-w-[50%]">
                                    <div className="h-full p-8 rounded-3xl bg-[#fbcb7e]">
                                        ...
                                        <a className="inline-flex items-center mb-6">
                                            ...
                                            <span className="flex-grow flex flex-col pl-4">
                                                ...
                                                <span className="text-white text-sm">{each?.designation}</span>
                                            </span>
                                        </a>
                                        <p className="leading-relaxed  text-white">{each?.testimonialDescription}</p>
